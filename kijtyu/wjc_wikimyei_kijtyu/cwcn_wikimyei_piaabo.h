...
typedef struct __trayectory { // #FIXME too many fields
    ...
    __cwcn_type_t __entropy_uwaabo_state;
    ...
    ___cwcn_bool_t __imibajcho_munaajpi_state; ...// this is J, varies while pending_munaajpi_index
    ___cwcn_bool_t *__imibajcho_munaajpi_duuruva_state; ...
} __trayectory_t;
