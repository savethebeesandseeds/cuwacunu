...
__trayectory_t *trayectory_fabric(__wikimyei_t *_wikimyei){
    ...
    new_trayectory->__pending_munaajpi=___CWCN_FALSE;
    ...
    new_trayectory->__uwaabo_adventage=malloc(_wikimyei->__uwaabo_state_size*sizeof(__cwcn_type_t));
    new_trayectory->__imibajcho_munaajpi_state=0x00; // this is J, varies while pending_munaajpi_index
    new_trayectory->__imibajcho_munaajpi_duuruva_state=malloc(_wikimyei->__munaajpi_duuruva->__duuruva_vector_size*sizeof(__cwcn_type_t));
    new_trayectory->__alliu_state=NULL;
    new_trayectory->__nonuwaabo_alliu_state=NULL; // ... #FIXME nonuwaabo null initiation means nothing
    new_trayectory->__entropy_uwaabo_state=0x00;
...
__wikimyei_t *wikimyei_fabric(
    ...
    new_wikimyei->__uwaabo_base_size=new_wikimyei->__alliu_duuruva->__duuruva_vector_size;
    new_wikimyei->__uwaabo_state_size=new_wikimyei->__ec->__total_cosa_params;
    new_wikimyei->__imibajcho_munaajpi_duuruva_state_size=new_wikimyei->__munaajpi_duuruva->__duuruva_vector_size;
    new_wikimyei->__munaajpi_base_size=\
        new_wikimyei->__tsane_state_size+\
        new_wikimyei->__uwaabo_state_size+\
        2*new_wikimyei->__alliu_state_size+\
...
int load_enqueue_trayectory(__wikimyei_t *_wikimyei, __trayectory_t *_new_trayectory){
    fprintf(stdout,">> load_enqueue_trayectory\n");
